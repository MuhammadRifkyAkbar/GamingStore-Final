 ...
 * @author Akbar
 */
public class PesananJualGame extends javax.swing.JFrame {
    private DefaultTableModel modelTabel;
    
private void tampilBarang() {
    // Mendapatkan semua beliGame dari database
    DAO_BeliGame daoBeliGame = new DAO_BeliGame();
    List<BeliGame> beliGameList = daoBeliGame.getAllBeliGames();

    // Membuat array untuk menyimpan kolom tabel
    Object[] baris = {"Nama Game", "Harga", "PPN", "Income", "Email"};

    // Membuat model tabel dengan array kolom
    DefaultTableModel modelTabel = new DefaultTableModel(null, baris);

    // Menambahkan data beliGame ke model tabel
    for (BeliGame beliGame : beliGameList) {
        Object[] data = {
            beliGame.getNamaGame(),
            beliGame.getHarga(),
            beliGame.getPpn(),
            beliGame.getIncome(),
            beliGame.getEmail()
    ...
    public static void main(String args[]) {
        SwingUtilities.invokeLater(() -> new PesananJualGame());
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesananJualGame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesananJualGame().setVisible(true);
            }
        });
    }
