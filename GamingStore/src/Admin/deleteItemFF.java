 ...
 * @author Akbar
 */
public class deleteItemFF extends javax.swing.JFrame {
...
private void tampilBarangFF() throws SQLException {
     ...
     */
    public deleteItemFF() throws SQLException {
        initComponents();
        tampilBarangFF();
    }
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        try {
            ...
            Logger.getLogger(deleteItemFF.class.getName()).log(Level.SEVERE, null, ex);
        }
        iml.setVisible(true) ;
    ...
    if (selectedRowIndex != -1) {
        Long idBarangToDelete = (Long) tabelFF.getValueAt(selectedRowIndex, 0);
        String nickToHapus = (String) tabelFF.getValueAt(selectedRowIndex, 2); // Assuming nickname is at index 2

        DefaultTableModel model = (DefaultTableModel) tabelFF.getModel();
        model.removeRow(selectedRowIndex);

        DAO_ItemFF daoItemFF = null;
        try {
            daoItemFF = new DAO_ItemFF(DBConnection.getConnection());
            daoItemFF.deleteItemByNickname(nickToHapus);
        } catch (SQLException ex) {
            Logger.getLogger(deleteItemFF.class.getName()).log(Level.SEVERE, null, ex);
        }
...
this.dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deleteItemFF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new deleteItemFF().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(deleteItemFF.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
