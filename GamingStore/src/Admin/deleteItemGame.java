 ...
 * @author Akbar
 */
public class deleteItemGame extends javax.swing.JFrame {
 ...
 private void tampilBarang() {
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        try {
            ...
            Logger.getLogger(deleteItemGame.class.getName()).log(Level.SEVERE, null, ex);
        }
        iml.setVisible(true) ;
    ...
    if (selectedRowIndex != -1) {
        Long idGameToDelete = (Long) tabelML.getValueAt(selectedRowIndex, 2);

        DefaultTableModel model = (DefaultTableModel) tabelML.getModel();
        model.removeRow(selectedRowIndex);

        DAO_ItemGame daoItemGame = new DAO_ItemGame();
        daoItemGame.deleteItemGameByID(idGameToDelete);
    } else {
...
this.dispose();        // TODO add your handling code here:
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        viewItemGame vi = new viewItemGame();
        vi.setVisible(true);
        this.dispose();         // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deleteItemGame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new deleteItemGame().setVisible(true);
            }
        });
    }
