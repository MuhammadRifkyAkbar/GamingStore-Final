 ...
 * @author Akbar
 */
public class viewItemGame extends javax.swing.JFrame {
...
private void tampilBarang() {
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(tabelML);
...
updateItemGame uml = new updateItemGame();
uml.setVisible(true);
this.dispose();// TODO add your handling code here:
    }//GEN-LAST:event_jLabel5MouseClicked

    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
            deleteItemGame dipubg = new deleteItemGame();
    dipubg.setVisible(true);
this.dispose();        // TODO add your handling code here:
    }//GEN-LAST:event_jLabel3MouseClicked

    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        viewItemGame vim = new viewItemGame();
vim.setVisible(true);
this.dispose();// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        SwingUtilities.invokeLater(() -> new viewItemGame());
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewItemGame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewItemGame().setVisible(true);
            }
        });
    }
